   ...
   pub fn dark() -> Theme {
      Theme {
         ...
         palette: ColorPalette {
            base: BaseColors {
               background: hex_to_color("#212121").unwrap(),
               foreground: hex_to_color("#424242").unwrap(),
            },
            normal: NormalColors {
               primary: hex_to_color("#1B4F72").unwrap(),
               secondary: hex_to_color("#7D6608").unwrap(),
               surface: hex_to_color("#626567").unwrap(),
               error: hex_to_color("#641E16").unwrap(),
            },
            bright: BrightColors {
               primary: hex_to_color("#2196F3").unwrap(),
               secondary: hex_to_color("#FFC107").unwrap(),
               surface: hex_to_color("#EEEEEE").unwrap(),
               error: hex_to_color("#F44336").unwrap(),
            },
         },
      }
   }
      ...
      Theme {
         ...
         palette: ColorPalette {
            ...
            normal: NormalColors {
               ...
               secondary: hex_to_color("#F1C40F").unwrap(),
               surface: hex_to_color("#BDC3C7").unwrap(),
               error: hex_to_color("#C0392B").unwrap(),
            },
            bright: BrightColors {
               primary: hex_to_color("#2962FF").unwrap(),
               secondary: hex_to_color("#FFAB00").unwrap(),
               surface: hex_to_color("#000000").unwrap(),
               error: hex_to_color("#D50000").unwrap(),
            },
         },
      }
   }
...
mod de {
   ...
   pub fn deserialize_color_hex_string<'de, D>(deserializer: D) -> Result<iced_native::Color, D::Error>
   where
