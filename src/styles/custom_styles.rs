    ...
    fn style(&self) -> container::Style {
        container::Style {
            background: Some(Background::Color(match self {
                ...
                Self::FadedNormalForeground(palette) | Self::FadedBrightForeground(palette) => {
                    Color {
                        a: 0.80,
    ...
    fn active(&self) -> button::Style {
        button::Style {
            text_color: match self {
                ...
                Self::Secondary(palette) | Self::SecondaryBoxed(palette) => {
    ...
    fn disabled(&self) -> button::Style {
        button::Style {
            ...
            background: Some(Background::Color(match self {
                ...
                Self::Default(_) | Self::Disabled(_) | Self::Selected(_) => match self
                    .active()
                    .background
                    .unwrap_or(Background::Color(Color::TRANSPARENT))
                {
