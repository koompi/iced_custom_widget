use crate::components::table::table::{self, Table};
use crate::components::table::table_column::{self, ColumnKey, TableColumn};
use crate::components::table::table_header::{self, TableHeader, ResizeEvent};

use iced::{scrollable, window, Element, Length, Sandbox, Settings, Scrollable, Color};

pub struct TableDemo {
    table_state: table::State<ColumnField>,
